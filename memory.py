...
# Mengatur API key
os.environ["HUGGINGFACEHUB_API_TOKEN"] = "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"  # Ganti dengan API key kamu
...
summary_memory = ConversationSummaryMemory(llm=HuggingFaceEndpoint(repo_id="google/flan-ul2"), input_key="input")
...
llm = HuggingFaceEndpoint(repo_id="google/flan-ul2", temprature=0)
